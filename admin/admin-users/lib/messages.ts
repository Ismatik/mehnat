...
export const MSG: Record<string, Tri> = {
  ...
  // ---- экран входа ----
  login_title: { ru: "Управление пользователями", tg: "Идоракунии корбарон", en: "User management" },
  login_sub: { ru: "Общая административная панель · МЕХНАТ", tg: "Панели умумии маъмурӣ · МЕХНАТ", en: "Shared admin panel · MEHNAT" },
  superadmin_only_full: { ru: "Доступ к этой панели разрешён только суперадминистратору.", tg: "Дастрасӣ ба ин панел танҳо барои суперадмин иҷозат аст.", en: "Access to this panel is for superadministrator only." },
